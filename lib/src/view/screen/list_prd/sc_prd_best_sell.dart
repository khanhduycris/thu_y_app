...
class ScPrdBestSell extends StatefulWidget {

  @override
  State<ScPrdBestSell> createState() => _ScPrdBestSellState();
}

class _ScPrdBestSellState extends State<ScPrdBestSell> {
  final prdBloc = BlocPrdBestSell();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: BlocBuilder<BlocPrdBestSell, CubitState>(
          bloc: prdBloc,
