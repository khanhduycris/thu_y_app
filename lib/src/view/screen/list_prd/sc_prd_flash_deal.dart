...
class ScPrdFlashDeal extends StatefulWidget {

  @override
  State<ScPrdFlashDeal> createState() => _ScPrdFlashDealState();
}

class _ScPrdFlashDealState extends State<ScPrdFlashDeal> {
  final prdBloc = BlocPrdFlashDeal();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: BlocBuilder<BlocPrdFlashDeal, CubitState>(
          bloc: prdBloc,
